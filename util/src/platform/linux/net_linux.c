...
get_sockaddr_ip_str(const struct sockaddr* addr)
{
    ...
    switch(addr->sa_family)
    {
        case AF_INET:
        {
            ...
            s = (char*)MALLOC(INET_ADDRSTRLEN, "get_sockaddr_ip_str()");
        ...
        case AF_INET6:
        {
            ...
            s = (char*)MALLOC(INET6_ADDRSTRLEN, "get_sockaddr_ip_str()");
        ...
        default:
             ...
             * it here. */
            s = (char*)MALLOC(sizeof(char) * 8, "get_sockaddr_ip_str()");
            strcpy(s, "unknown");
            break;
    }
...
net_udp(const char* node, const char* port, uint32_t max_connections, char is_host)
{
    ...
    connection = (struct net_connection_t*)MALLOC(sizeof *connection, "net_udp()");
    if(!connection)
        return NULL;
